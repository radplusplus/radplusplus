...
# class GenerateProductionOrder(Document):
	# def __init__(self, arg1, arg2=None):
		# super(GenerateProductionOrder, self).__init__(arg1, arg2)
		# self.item_dict = {}
	...
	# def get_so_items(self):
		...
		# # renmai - 2017-03-06 - ajout du name.
		...
		# # renmai - 2017-03-06 - ajout du so_item.name.
		# packed_items = frappe.db.sql("""select distinct pi.parent, pi.item_code, pi.warehouse as warehouse,
			# so_item.name , (((so_item.qty - so_item.delivered_qty) * pi.qty) / so_item.qty)
				# as pending_qty
